...
if ( ! class_exists( 'Zakra_Customizer' ) ) :
	...
	class Zakra_Customizer {
		...
		public function zakra_register_panel( $wp_customize ) {
			...
			require_once $control_dir . '/php/class-zakra-customize-upsell-control.php'; // TODO: Remove this in future update as this has no use.
			...
			require_once $control_dir . '/php/class-zakra-customize-upgrade-control.php';
			...
			$wp_customize->register_control_type( 'Zakra_Customize_Upgrade_Control' );
