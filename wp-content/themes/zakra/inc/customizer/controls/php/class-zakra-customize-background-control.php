		...
		<div class="background-wrapper">
			...
			<# if ( 'background-color' in data.default ) { #>
				...
				<div class="background-color">
					<# if ( 'background-image' in data.default ) { #>
						<h4><?php esc_html_e( 'Background Color', 'zakra' ); ?></h4>
					<# } #>
			...
			<# if ( 'background-image' in data.default ) { #>
				...
				<div class="background-image">
					<# if ( 'background-color' in data.default ) { #>
						<h4><?php esc_html_e( 'Background Image', 'zakra' ); ?></h4>
					<# } #>
					<div class="attachment-media-view background-image-upload">
						...
						<# } else { #>
						<div class="placeholder"><?php esc_html_e( 'No File Selected', 'zakra' ); ?></div>
						<# } #>
						<div class="actions">
							<button class="button background-image-upload-remove-button<# if ( ! data.value['background-image'] ) { #> hidden <# } #>"><?php esc_html_e( 'Remove', 'zakra' ); ?></button>
							<button type="button"
									class="button background-image-upload-button"><?php esc_html_e( 'Select File', 'zakra' ); ?></button>
						</div>
					</div>
				</div>
			<# } #>
			...
			<div class="background-repeat">
				<h4><?php esc_html_e( 'Background Repeat', 'zakra' ); ?></h4>
			...
			<div class="background-position">
				<h4><?php esc_html_e( 'Background Position', 'zakra' ); ?></h4>
				<select {{{ data.inputAttrs }}}>
			...
			<div class="background-size">
				<h4><?php esc_html_e( 'Background Size', 'zakra' ); ?></h4>
				<div class="buttonset">
					...
					<label class="switch-label switch-label-<# if ( 'cover' === data.value['background-size'] ) { #>on <# } else { #>off<# } #>"
							for="{{ data.id }}cover"><?php esc_html_e( 'Cover', 'zakra' ); ?></label>
					</input>
					...
					<label class="switch-label switch-label-<# if ( 'contain' === data.value['background-size'] ) { #>on <# } else { #>off<# } #>"
							for="{{ data.id }}contain"><?php esc_html_e( 'Contain', 'zakra' ); ?></label>
					</input>
					...
					<label class="switch-label switch-label-<# if ( 'auto' === data.value['background-size'] ) { #>on <# } else { #>off<# } #>"
							for="{{ data.id }}auto"><?php esc_html_e( 'Auto', 'zakra' ); ?></label>
					</input>
				</div>
			</div>
			...
			<div class="background-attachment">
				<h4><?php esc_html_e( 'Background Attachment', 'zakra' ); ?></h4>
				<div class="buttonset">
					...
					<label class="switch-label switch-label-<# if ( 'scroll' === data.value['background-attachment'] ) { #>on <# } else { #>off<# } #>"
							for="{{ data.id }}scroll"><?php esc_html_e( 'Scroll', 'zakra' ); ?></label>
					</input>
					...
					<label class="switch-label switch-label-<# if ( 'fixed' === data.value['background-attachment'] ) { #>on <# } else { #>off<# } #>"
							for="{{ data.id }}fixed"><?php esc_html_e( 'Fixed', 'zakra' ); ?></label>
					</input>
				</div>
			</div>
