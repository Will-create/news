...
if ( ! function_exists( 'zakra_background_color' ) ) :
	/**
	 * Modifies WordPress custom background option.
	 */
	function zakra_background_color() {
		?>
		<style id="background-color-css">
			body.custom-background #page { background-color: #<?php echo get_background_color(); ?> }
		</style>
		<?php
	}
endif;
...
if ( ! function_exists( 'zakra_header_main' ) ) :
	...
	function zakra_header_main() {
		...
		if ( true !== get_theme_mod( 'zakra_enable_dual_menu', false ) ) {
			/**
